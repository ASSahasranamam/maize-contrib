...
class StripEpoch(Node):
    ...
    tags = {"chemistry", "utility", "generation", "active-learning"}
...
class ReinventEntry(Node):
    ...
    """
    tags = {"chemistry", "utility", "generation", "loading", "interface"}
...
class ReinventExit(Node):
    ...
    """
    tags = {"chemistry", "utility", "generation", "saving", "interface"}
